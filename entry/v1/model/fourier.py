...
FLAGS = foo()
# determines whether we use the magnitude or complex valued numbers
FLAGS.use_magnitude = True
...
class model(object):
    ...
    def build_graph(self, model_name=None):
        ...
        self.output, self.seq_len = self.get_layers(
            self.seq_len, self.input, self.featureindices, self.use_magnitude)
