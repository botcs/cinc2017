...
FLAGS.kernel_size = 5
FLAGS.keep_prob = 0.5
FLAGS.out_dims = '512, 1024'
FLAGS.kernel_sizes = '128, 64'
...
class model(object):
    ...
    def get_layers(self, in_node, out_dims, kernel_sizes, keep_prob, use_bnorm=True):
        '''
